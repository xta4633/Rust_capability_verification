...
Definition Obj_try_take_action_mut_lemma (π : thread_id) : Prop :=
  ∀ (BTreeMap_KVA_get_mut_constObj_Cap_std_alloc_Global_constObj_loc : loc) (Cap_contains_loc : loc) (Option_T_is_some_mutCap_loc : loc) (Option_T_unwrap_mutCap_loc : loc) , 
  ...
  BTreeMap_KVA_get_mut_constObj_Cap_std_alloc_Global_constObj_loc ◁ᵥ{π} BTreeMap_KVA_get_mut_constObj_Cap_std_alloc_Global_constObj_loc @ function_ptr [PtrSynType; PtrSynType] (type_of_BTreeMap_KVA_get_mut (loc) (PtrSynType) (Cap_inv_t_rt) (Cap_st) (Global_rt) ((Global_sls : syn_type))(*  (loc) (PtrSynType) *)) -∗
  ...
  typed_function π (Obj_try_take_action_mut_def BTreeMap_KVA_get_mut_constObj_Cap_std_alloc_Global_constObj_loc  Cap_contains_loc  Option_T_is_some_mutCap_loc  Option_T_unwrap_mutCap_loc  ) [((Option_els ((PtrSynType))) : syn_type); ((Option_els ((PtrSynType))) : syn_type); PtrSynType; PtrSynType; PtrSynType; PtrSynType; UnitSynType; BoolSynType; PtrSynType; UnitSynType; PtrSynType; ((Option_els ((PtrSynType))) : syn_type); BoolSynType; PtrSynType; IntSynType USize; PtrSynType] (type_of_Obj_try_take_action_mut ).
End proof.

Ltac Obj_try_take_action_mut_prelude :=
  unfold Obj_try_take_action_mut_lemma;
  set (FN_NAME := FUNCTION_NAME "Obj_try_take_action_mut");
  intros;
  iStartProof;
  let ulft_2 := fresh "ulft_2" in
  let ulft_1 := fresh "ulft_1" in
  start_function "Obj_try_take_action_mut" ( [ [ [] ulft_2] ulft_1] ) ( [ [ [ [  self obj ] action ] γ1 ] γ2 ] );
  ...
  prepare_parameters ( self obj action γ1 γ2 );
